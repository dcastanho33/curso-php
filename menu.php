<nav class="modulos">
    <div class="modulo laranja">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=db&file=excluir_1">Excluir #01</a></li>
    ...
    <div class="modulo roxo-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=includes&file=require_return">Require e Return</a></li>
    ...
    <div class="modulo azul-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=classes_objetos&file=classe_data">Desafio Classe Data</a></li>
    ...
    <div class="modulo laranja">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=array&file=desafio_indice">Desafio Index</a></li>
            <li><a href="exercicio.php?dir=array&file=desafio_meses">Desafio Meses</a></li>
            <li><a href="exercicio.php?dir=array&file=operacoes_array">Operações</a></li>
    ...
    <div class="modulo roxo">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=controle&file=desafio_switch1">Desafio Switch #1</a></li>
        </ul>
    </div>
    <div class="modulo azul">
        <h3>3. Variáveis</h3>
